...
class Assessment:
    ...
    def __init__(self, company: Company, answers: dict[str, Answer] | None = None) -> None:
    ...
    def overall_score(self) -> float:
        """Overall score: the mean of the eight per-condition scores."""
        scores = list(self.condition_scores().values())
        return round(sum(scores) / len(scores), 1)
